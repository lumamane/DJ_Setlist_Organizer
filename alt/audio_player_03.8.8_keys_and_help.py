...
class AudioPlayer(QMainWindow):
    ...
    def setup_shortcuts(self):
        ...
        # Navigation
        QShortcut(QKeySequence("Return"), self, activated=lambda: self.play_selected(self.file_list.currentItem()) if self.file_list.currentItem() else None)
    ...
    def show_help(self):
        ...
        <h3>Navigation</h3>
        <table border="1" cellpadding="5" cellspacing="0">
            <tr><td><b>Enter</b></td><td>Play Selected Track</td></tr>
