...
class AudioPlayer(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.folder_name_label.setStyleSheet("color: #eee; font-weight: bold;")
        info_grid.addWidget(self.folder_name_label, 0, 1)
    ...
    def update_folder_info(self, total_seconds=None, remaining_seconds=None):
        """Update the folder info label with folder name, total and remaining time."""
