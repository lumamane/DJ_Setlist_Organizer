...
class AudioSetlist(QMainWindow):
    def __init__(self):
        ...
        # UI setup (sidebar + main area defined in Part 2)
        self.setup_ui()

        # Shortcuts (defined in Part 2)
    ...
    def setup_ui(self):
        ...
        root_layout.setSpacing(4)   # tighter spacing
        ...
        self.btn_refresh.setToolTip("Reload the current folder")
        ...
        rename_label.setStyleSheet("font-weight: bold; margin-top: 6px;")
        ...
        self.btn_rename_all.setToolTip("Rename every file in the playlist using sequential numbers.")
        ...
        self.btn_undo_rename.setToolTip("Restore previous filenames on disk.")
        ...
        order_label.setStyleSheet("font-weight: bold; margin-top: 6px;")

        self.btn_undo_order = QPushButton("Undo Order Change")
        self.btn_undo_order.clicked.connect(self.undo_order_change)
        self.btn_undo_order.setToolTip("Undo the last playlist reorder.")
        ...
        help_label.setStyleSheet("font-weight: bold; margin-top: 6px;")
    ...
    def rename_selected_file(self):
        ...
        new_name, ok = QMessageBox.getText(self, "Rename File", "New filename:", text=track.name)
    ...
    def show_help(self):
        ...
        <h3 style="color:#eee;">Tips</h3>
        <ul>
          <li>Use <b>Rename All</b> to lock in your setlist order for USB/CDJ players.</li>
          <li>Undo/Redo for renaming is separate from playlist order undo/redo.</li>
