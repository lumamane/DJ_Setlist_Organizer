...
class DJApp(QMainWindow):
    def __init__(self):
        ...
        # Audio setup
        sd.default.samplerate = None  # Use file's native rate
    ...
    def init_ui(self):
        ...
        self.song_table.setColumnWidth(2, 120)  # songfile
        self.song_table.setColumnWidth(3, 50)   # ext
        self.song_table.setColumnWidth(4, 250)  # Filename
        self.song_table.setColumnWidth(5, 250)  # alterFilenameTo
