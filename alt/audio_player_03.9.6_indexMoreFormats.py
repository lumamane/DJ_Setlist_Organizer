...
class AudioPlayer(QMainWindow):
    ...
    def setup_shortcuts(self):
        ...
        # Help
        QShortcut(QKeySequence("Ctrl+H"), self, activated=self.show_help)
    ...
    def show_help(self):
        ...
        <table border="1" cellpadding="5" cellspacing="0">
            ...
            <tr><td><b>Ctrl+Shift+R</b></td><td>Rename All Files</td></tr>
    ...
    def rename_all(self):
        ...
        for i, file in enumerate(self.playlist):
            ...
            # Strip any existing index (e.g., "100_song.mp3" or "100 song.mp3" -> "song.mp3")
    ...
    def rename_selected_file(self):
        ...
        if not matching_files:
            QMessageBox.warning(self, "Error", "Selected file not found in playlist.")
            return
        ...
        new_name, ok = QInputDialog.getText(
            self, "Rename File", "Enter new filename:", text=name
        )
        if ok and new_name:
            ...
            try:
                if os.path.exists(new_path):
                    QMessageBox.warning(self, "Error", f"Destination file already exists: {new_basename}")
                    return
